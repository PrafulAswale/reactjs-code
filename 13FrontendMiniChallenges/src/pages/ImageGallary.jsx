...
function ImageGallary() {
  ...
  return (
    <div>
      <h1 className="text-center m-5 font-medium text-2xl dark:text-white">
        ImageGallary
      </h1>
      <div className="flex gap-6 justify-center flex-wrap">
        {images.map((img, index) => (
          <img
            ...
            src={img}
            alt={"Cat" + index}
            className="w-[250px] h-[250px] rounded-md shadow-md hover:scale-110"
            onClick={onClickHandler}
          />
        ))}
      </div>

      <h3 className="text-center m-2 font-medium text-2xl dark: text-white">
        Selected Image
      </h3>
      <div className="flex justify-center m-2 text-center">
        {src !== "" && (
          <img
            src={src}
            alt="Cat"
            className="m-5 rounded-lg w-[350px] h-[250px]"
          />
        )}
      </div>
    </div>
